...
for i in 1 2 3 4 5
do
   	python main_plot.py --network convnet --dataset fashion-mnist --learning_rate 0.003 --step_info true --momentum 0.9 --damping 0.1 --device $device --optimizer ngd --epoch $epochs --milestone 10,20,30,40,50 --weight_decay 0.001 --batch_size 128
done
