...
for i in 1
do
	python main_autoencoder.py --network autoencoder --dataset mnist --device $device --optimizer ngd  --epoch $epochs --learning_rate 0.1 --learning_rate_decay 1 --damping 3 --stat_decay 0.0 --weight_decay 0.0 --TCov 20 --freq 10 --momentum 0.9 --batch_size 100
done
echo 'NGD Finished'
