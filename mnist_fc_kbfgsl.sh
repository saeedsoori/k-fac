...
do
	...
	do
   		python main.py --network fc --dataset mnist --learning_rate $lr --step_info true --momentum 0.9 --damping $damping --device $device --optimizer kbfgsl  --epoch $epochs   --weight_decay 0.003 --batch_size 128
	done
done
